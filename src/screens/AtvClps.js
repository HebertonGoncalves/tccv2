...
export default function AtvClps({navigation}) {
    ...
    return (
            <SafeAreaView style={styles.container}>
              <SafeAreaView><Text>Ajude o projeto ! compre pelos meus links de afiliado da Amazon !</Text></SafeAreaView>
                <TouchableOpacity  style={styles.cartoes} onPress={() => navigation.navigate("Atividade 1 - CLPs")}>
                ...
                <TouchableOpacity style={styles.cartoes} onPress={() => navigation.navigate("Atividade 2 - CLPs")}>
                ...
                <TouchableOpacity style={styles.cartoes} onPress={() => navigation.navigate("Atividade 3 - CLPs")}>
                ...
                <TouchableOpacity style={styles.cartoes} onPress={() => navigation.navigate("Atividade 4 - CLPs")}>
